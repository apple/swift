...
g0(X.f1) // expected-error{{calling a 'mutating' method without an argument list is not allowed}}
...
var z = Z(i: 0)
var getI = z.getI
var incI = z.incI // expected-error{{calling a 'mutating' method without an argument list is not allowed}}
var zi = z.getI()
