...
let x = Foo.boom // expected-error{{calling a 'mutating' method without an argument list is not allowed}}
var y = Foo()
...
func fromLocalContext() -> (inout Foo) -> () -> () {
  return Foo.boom // expected-error{{calling a 'mutating' method without an argument list is not allowed}}
}
...
_ = bar().boom       // expected-error{{calling a 'mutating' method without an argument list is not allowed}}
_ = bar().boom(&y)   // expected-error{{calling a 'mutating' method without an argument list is not allowed}}
_ = bar().boom(&y)() // expected-error{{calling a 'mutating' method without an argument list is not allowed}}

func foo(_ foo: Foo.Type) {
  _ = foo.boom       // expected-error{{calling a 'mutating' method without an argument list is not allowed}}
