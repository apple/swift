...
static bool isUniquelyReferenced(const void *object) {
  static auto objcIsUniquelyRefd = reinterpret_cast<bool (*)(const void *)>(
      dlsym(RTLD_DEFAULT, "objc_isUniquelyReferenced"));
